        ...
        <CardHeader className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <CardDescription className="max-w-3xl text-base leading-7 text-slate-300">
              Tohle je první reálná business vrstva MVP. Admin tu vidí klienty, jejich priority a
              navázané workflow. Formulář pro založení nového klienta jsme přesunuli do samostatného
              overlay okna, aby seznam zůstal čistý a přehledný.
            </CardDescription>
          </div>
        </CardHeader>
